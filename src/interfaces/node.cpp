...
class NodeImpl : public Node
{
    ...
    void selectParams(const std::string& network, int64_t regtestDifficulty, int64_t simuLambda, int64_t miningMode) override { SelectParams(network, regtestDifficulty, simuLambda, miningMode); }
